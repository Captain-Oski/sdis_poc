...
# &&
# sudo docker compose run --rm ogr ogr2ogr -f PostgreSQL -nln sdis.indice_emv_data -overwrite -oo AUTODETECT_TYPE=YES PG:"dbname='sdis' host='172.18.0.4' port='5432' user='admin_geo' password='password'"  ./data/indice_emv_data.csv  \
# &&
